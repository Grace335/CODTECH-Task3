...
// Function to handle paragraph separation in blog content
function formatContent(content) {
  // Split content into paragraphs based on double newlines (assumption: paragraphs are separated by a blank line)
...
function renderBlogs(blogsToRender = blogs) {
  blogList.innerHTML = blogsToRender.map(blog => `
    <article class="blog-card">
      <h2>${blog.title}</h2>
      ${formatContent(blog.content)}  <!-- Format content with paragraphs -->
      <div class="blog-meta">
